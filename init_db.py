...
def _apply_migrations():
    ...
    # Mecanismo próprio, independente de grupos_clientes: um set agrupa empresas
    # cujas memorizações devem ser idênticas. Ver migrations/012_create_memo_clone.sql.
    _migrate("""
